...
/// including the TestHost WebSocket from <c>WebApplicationFactory</c>.
/// </summary>
public sealed class VestaTestClient : IAsyncDisposable
{
    ...
    /// <summary>
    /// Perform the HELLO/WELCOME handshake and start the receive loop.
    /// </summary>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Receive until WELCOME (errors may arrive first for invalid channels)
        while (true)
        {
    ...
    public async Task DisconnectAsync(CancellationToken cancellationToken = default)
    {
        ...
        if (_receiveLoop is not null)
        {
            ...
            catch (OperationCanceledException) { /* timed out — force it */ }
        }
